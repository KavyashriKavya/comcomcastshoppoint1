package com.shoppoint.adminmoduletest;
...
public class AdminmodelTest extends Baseclass  {
	...
	@Test
	public void DefectTest() throws Exception {
		
		FileUtility fLib=new FileUtility();
		String ausername = fLib.getDataFromPropertyFile("Adminusername");
		String apassword = fLib.getDataFromPropertyFile("Adminpwd");
